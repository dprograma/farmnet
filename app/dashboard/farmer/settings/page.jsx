      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <motion.div variants={fadeInUp}>
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-medium text-neutral-900">Weather Alerts</h4>
                    <p className="text-sm text-neutral-600">Receive important weather updates</p>
                  </div>
                  <ToggleSwitch
                    enabled={settings.notifications.weatherAlerts}
                    onToggle={() => toggleSetting('notifications', 'weatherAlerts')}
                  />
                </div>
          ...
          <motion.div variants={fadeInUp}>
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <FiEye className="w-5 h-5 mr-2 text-primary-600" />
                  Privacy
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <ToggleSwitch
                    ...
                    onToggle={() => toggleSetting('privacy', 'profileVisible')}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-neutral-600">Allow buyers to see your contact information</p>
                  </div>
                  <ToggleSwitch
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h4 className="font-medium text-neutral-900">Farm Data Visibility</h4>
                    <p className="text-sm text-neutral-600">Share farm data for market insights</p>
                  </div>
                  <ToggleSwitch
                    enabled={settings.privacy.farmDataVisible}
                    onToggle={() => toggleSetting('privacy', 'farmDataVisible')}
                  />
                </div>
          ...
          <motion.div variants={fadeInUp}>
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center">
                  <FiGlobe className="w-5 h-5 mr-2 text-primary-600" />
                  Preferences
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
        ...
        <motion.div variants={fadeInUp}>
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center">
                <FiLock className="w-5 h-5 mr-2 text-primary-600" />
                Change Password
              </CardTitle>
            </CardHeader>
            <CardContent>
